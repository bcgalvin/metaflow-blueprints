...
/**
 * MetadataSchema defines the metadata for Kubernetes API objects.
 *
 * @see ApiObjectMetadata
 */
  ...
  .object({
    ...
    ownerReferences: z
      .array(
        z.object({
          /**
           * The API version of the referent.
           */
          apiVersion: z.string(),
          ...
          /**
           * Indicates if the deletion of this reference should block the deletion of the resource.
           */
...
/**
 * Metadata type inferred from MetadataSchema.
 */
